...
const cacheName = 'Fixit9ControlsIanOgea-2020-10-24 20:36:12.234863'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit9ControlsIanOgea'.length) === 'Fixit9ControlsIanOgea') {
